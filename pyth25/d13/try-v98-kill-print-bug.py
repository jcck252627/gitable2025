...
# word_per_page = 0   ... this assigned to zero !
pages = int(input("Number of pages: "))
word_per_page = int(input("Number of words per page: ")) ## corrected with only 1 equal symbol
print(f"number of page you entered:  {pages}")
print(f"number of words per page you entered: {word_per_page}")
